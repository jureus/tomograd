...
if (!empty($result['services'])) {
    ...
    $iblockIds = array_unique(array_column($result['services'], 'PARAM2'));
...
// 3. Вывод компонентов с фильтрами
if (!empty($arComponentFilters['actions'])) {
    $GLOBALS['arFilterActions'] = $arComponentFilters['actions'];
