        ...
        <div class="container">
            <div class="block__padd__title">
                <div class="row flex-nowrap align-items-end">
                    ...
                    <div class="col-12 col-md-auto d-none d-md-block"><a class="link__more" href="#"><span>Смотреть все документы</span><i>
                                <svg>
						...
						<?foreach($arResult["ITEMS"] as $arItem){?>
							...
							<div class="licenses__slider__item swiper-slide" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
								<a class="licenses__card"
                                    href="<?=$arItem["DETAIL_PICTURE"]["SAFE_SRC"]?>"
            ...
            <div class="block__padd__more d-md-none"><a class="link__more"
                                                        href="#"><span>Смотреть все документы</span><i>
                        <svg>
                            <use xlink:href="<?= SITE_TEMPLATE_PATH ?>/img/icons.svg#ic-right"></use>
                        </svg>
                    </i></a></div>
