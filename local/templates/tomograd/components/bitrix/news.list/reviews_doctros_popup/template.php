                    ...
                    <form class="form" action="#">
                        <div class="form__line row">
                            ...
                            <div class="col-12 col-lg-4" id="ftab_0">
                                <div class="autocomplete js--autocomplete"><label
                                            ...
                                            <ul>
												<? foreach ($arResult["ITEMS"] as $arItem) { ?>
													<li class="js--autocomplete-list-item">
														<?=$arItem["NAME"]?>
														<input type="hidden" value="<?=$arItem["NAME"]?>" data-id=<?=$arItem["ID"]?>/>
													</li>
												<?}?>
                                            </ul>
                                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    reviewForm.addEventListener('submit', function(e) {
        ...
        if (selectedDoctor) {
            const hiddenInput = selectedDoctor.querySelector('input[type="hidden"]');
