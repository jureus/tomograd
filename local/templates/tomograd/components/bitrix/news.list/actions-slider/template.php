		...
		<div class="block__padd__title">
			<div class="row flex-nowrap align-items-end">
				<div class="col-12 col-md">
					<h2 class="h2">Другие акции</h2>
				</div>
				<div class="col-12 col-md-auto d-none d-md-block"><a class="link__more" href="#"><span>Смотреть все акции</span><i><svg>
					<use xlink:href="img/icons.svg#ic-right"></use>
				</svg></i></a></div>
			</div>
		</div>
		<div class="actionselse__slider__offset js--sl-actionselse-offset"></div>
		<div class="actionselse">
			<div class="actionselse__slider swiper js--sl-actionselse">
				<div class="swiper-wrapper">
					...
					<?foreach($arResult["ITEMS"] as $arItem) {?>
						...
						<div class="actionselse__slider__item swiper-slide" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
