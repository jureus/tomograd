...
?>
<section class="block__padd block__overflow" id="doctors">
	<div class="container">
		<div class="block__padd__title">
			<div class="row flex-nowrap align-items-end">
				...
				<div class="col-12 col-md-auto d-none d-md-block"><a class="link__more" href="/doctors/"><span>Смотреть всех специалистов</span><i>
					<svg>
