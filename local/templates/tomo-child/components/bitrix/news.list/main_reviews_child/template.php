...
?>
<div class="block__padd block__overflow">
    <div class="container">
        <div class="block__padd__title">
            <div class="row flex-nowrap align-items-end">
                ...
                <div class="col-12 col-md-auto d-none d-md-block"><a class="link__more" href="#"><span>Смотреть все отзывы</span><i><svg>
        ...
        <div class="reviews">
            <div class="reviews__slider__btns d-none d-lg-block">
                <div class="slider__nav">
                    <div class="slider__nav__btn left js--sl-reviews-prev"><svg>
                        <use xlink:href="<?= SITE_TEMPLATE_PATH ?>/img/icons.svg#ic-left"></use>
                    </svg></div>
                    <div class="slider__nav__btn right js--sl-reviews-next"><svg>
                        <use xlink:href="<?= SITE_TEMPLATE_PATH ?>/img/icons.svg#ic-right"></use>
                    </svg></div>
                </div>
            </div>
            <div class="reviews__body">
                                ...
                                <div class="reviews__card">
                                    <div class="reviews__card__head">
                                        <div class="row align-items-center justify-content-between">
                                            ...
                                            <div class="col-12">
                                                <div class="reviews__card__head__name"><?=$arItem["NAME"]?></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="reviews__card__center">
                                        <div class="reviews__card__center__body">
                                            ...
                                            <div class="reviews__card__text">
                                                <div class="reviews__card__text__body"><?=$arItem["~DETAIL_TEXT"]?></div>
                                                <div class="reviews__card__text__more"><a href="#"><span>Читать дальше</span><i><svg>
                                                    <use xlink:href="<?= SITE_TEMPLATE_PATH ?>/img/icons.svg#ic-right"></use>
                                                </svg></i></a></div>
                                            </div>
                                        </div>
                ...
                <div class="block__padd__more d-md-none"><a class="link__more" href="#"><span>Смотреть все отзывы</span><i><svg>
                    <use xlink:href="<?= SITE_TEMPLATE_PATH ?>/img/icons.svg#ic-right"></use>
                </svg></i></a></div>
            </div>
            <div class="reviews__aside">
                <div class="reviews__invite">
                    <div class="reviews__invite__img"><img src="<?= SITE_TEMPLATE_PATH ?>/img/dpchildren/bg-revoew-invite.png" alt="" /></div>
                    <div class="reviews__invite__center">
                        <div class="reviews__invite__title">Нам важно<br />Ваше мнение</div>
                        <div class="reviews__invite__text">Расскажите о&nbsp;своих впечатлениях во&nbsp;время сотрудничества.</div>
                    </div>
                    <div class="reviews__invite__footer"><a class="reviews__invite__btnpink d-block w-100" href="#">Оставить отзыв</a></div>
                </div>
            </div>
        </div>
    </div>
